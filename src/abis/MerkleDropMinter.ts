export const abi = [
  ...
  {
    "inputs": [
      { "internalType": "uint32", "name": "available", "type": "uint32" }
    ],
    "name": "ExceedsAvailableSupply",
    "type": "error"
  },
  { "inputs": [], "name": "ExceedsMaxPerAccount", "type": "error" },
  { "inputs": [], "name": "FeeRegistryIsZeroAddress", "type": "error" },
  ...
  { "inputs": [], "name": "MerkleRootHashIsEmpty", "type": "error" },
  {
    "inputs": [
      {
  ...
  },
  {
    ...
    "outputs": [
      { "internalType": "uint128", "name": "mintId", "type": "uint128" }
    ],
    "stateMutability": "nonpayable",
    "type": "function"
  },
    ...
    "outputs": [
      {
        "components": [
          ...
          { "internalType": "uint32", "name": "totalMinted", "type": "uint32" },
          {
            "internalType": "bytes32",
            "name": "merkleRootHash",
            "type": "bytes32"
